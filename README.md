...
- 🎉 **Opening** 2026. 10. 29 (목) 오후 5시 30분
- 📅 **Exhibition** 2026. 10. 30 (금) – 11. 04 (수)
- 🕙 **관람 시간** 10.30–11.03 10:00–18:00 / 11.04 10:00–14:00
- 📍 **Space Sophora Gallery** (서울 중구 덕수궁길 114, B1)
- 📷 Instagram [@dsid_2026](https://instagram.com/dsid_2026)

별도 빌드 없이 `index.html`로 동작하는 정적 웹 페이지입니다. **사물함 문을 탭하면 열리는 인트로 애니메이션**,
메인 포스터, 전시 정보, 교수진·졸업준비위원회·참가자 명단, 스크롤 리빌,
네이버·구글·카카오 지도 연결, 오프닝 일정 추가(.ics), 모바일 공유 기능이 포함되어 있습니다.
...
- `assets/locker-door.webp`: 첫 화면 사물함 문
- `assets/main-poster.webp`: 문 안쪽과 본문에 표시되는 메인 포스터
